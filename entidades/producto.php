...
class Producto {
  ...
  public function obtenerTodos(){
    ...
    public function actualizarStock($id){
        ...
        $mysqli = new mysqli(Config::BBDD_HOST, Config::BBDD_USUARIO, Config::BBDD_CLAVE, Config::BBDD_NOMBRE);
        $sql = " SELECT (P.cantidad - SUM(V.cantidad)) as diferencia from productos P, ventas V WHERE fk_idproducto = $id AND idproducto=$id";
        $sql2= " SELECT cantidad as diferencia From productos Where idproducto = $id";
       ...
       if($stock["diferencia"] === null){

        $stock = mysqli_fetch_array($result2);
